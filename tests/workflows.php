...
check(buttons(Keyboards::serverMenu(1))===['users:1:1:all','new_usr:1','srch_usr:1','admins_list:1:1','new_adm:1','srch_adm:1','stats:1','act_menu:1','srv_cfg:1','home'],'Server menu order does not match the requested layout');
